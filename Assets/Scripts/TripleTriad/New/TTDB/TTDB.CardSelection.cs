...
{
    [Header("Card Selection Cursor Memory")]
    [SerializeField] int _fingerLocationOnCurrentPage;
    ...
    [SerializeField] TripleTriadCard[] myHandTripleTriadCards;
    ...
    public void UpdateCardSelectionFingerPositionForScrollingInDb(CardSelectionState.WhichUpDownDirection whichUpDownDirection)
    {
    ...
    public void UpdateCardSelectionFingerPositionForPageScrollingInDb(CardSelectionState.PageScrollDirections whichPageScrollDirection)
    {
        ...
        CardSelectionState.WhichUpDownDirection whichUpDownDirection)
    {
        switch (whichUpDownDirection)
        {
            ...
            case CardSelectionState.WhichUpDownDirection.IsMovingUp:
                ...
                _currentSpotInCardInventory = _currentSpotInCardInventory + ttMan.ttUi.RetrieveNumberOfCardsActiveOnPage(_currentPageNumber) -1;
                break;
        }
    }
    ...
    public void UpdateMyHandTripleTriadCardsWithMySelectionList()
    {
        ...
        {
            myHandTripleTriadCards[i].whatCardIAm = currentBattleSelectableCards[currentHandSelectionsList[i].spotInCardInv];
        }
    }
