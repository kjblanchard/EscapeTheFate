...
public class FPSScript : MonoBehaviour
{
    ...
    int[] fpsBuffer;
    int fpsBufferIndex;
    private int HighestFPS { get; set; }
    ...
    void Update () {
        ...
        highestFPSLabel.text =
            stringsFrom00To99[Mathf.Clamp(HighestFPS, 0, 99)];
        averageFPSLabel.text =
            stringsFrom00To99[Mathf.Clamp(AverageFPS, 0, 99)];
        lowestFPSLabel.text =
            stringsFrom00To99[Mathf.Clamp(LowestFPS, 0, 99)];
    }
